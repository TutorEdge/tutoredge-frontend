        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block">
              <Image src="/images/logo.png" alt="TutorEdge Logo" width={160} height={40} />
            </Link>
            ...
            <div className="mt-6 space-y-2 text-gray-400 text-sm">
              <p className="flex items-center gap-2">
                <FaMapMarkerAlt className="text-indigo-500" /> 123, TutorEdge Street, Varanasi
              </p>
              <p className="flex items-center gap-2">
                <FaEnvelope className="text-indigo-500" /> support@tutoredge.com
              </p>
              <p className="flex items-center gap-2">
    ...
    link.name === 'Sitemap'
      ...
      <div className="border-t border-gray-700 bg-slate-900 p-6">
        <p className="text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} TutorEdge. All rights reserved. Made with ❤️ by TutorEdge
          Team.
        </p>
      </div>
    </footer>
