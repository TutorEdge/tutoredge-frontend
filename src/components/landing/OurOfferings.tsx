        ...
        {offeringsData.map((offering, index) => (
          ...
          >
            <div className="relative aspect-video w-full overflow-hidden rounded-t-2xl">
              ...
              />
              <div className="absolute inset-0 rounded-t-2xl bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-70"></div>
            </div>
            ...
            <div className="p-5">
              ...
              <button className="hover:bg-primary-dark rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white transition">
                Learn More
              </button>
            </div>
          </motion.div>
