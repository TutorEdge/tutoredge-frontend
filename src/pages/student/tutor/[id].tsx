        ...
        <div className="rounded-xl border bg-white p-6 md:col-span-2">
          <div className="flex items-start gap-4">
            <div className="relative h-24 w-24 overflow-hidden rounded-full">
              <Image src="/images/tutors/tutor-1.jpg" alt="Tutor avatar" fill style={{ objectFit: 'cover' }} />
            </div>
            <div>
              <div className="text-xl font-semibold">Ananya Gupta</div>
              <div className="text-gray-600">Mathematics • 4.9★</div>
              <p className="mt-3 text-gray-700">
                Experienced Math tutor focusing on concepts, problem-solving, and exam readiness.
                Sessions are interactive with practice sheets and weekly assessments.
              </p>
            </div>
          </div>
