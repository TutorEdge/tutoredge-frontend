...
const tutors = [
  { id: 'ananya', name: 'Ananya Gupta', subject: 'Mathematics', rating: 4.9, avatar: '/images/tutors/tutor-1.jpg' },
  { id: 'rahul', name: 'Rahul Mehta', subject: 'Physics', rating: 4.8, avatar: '/images/tutors/tutor-2.jpg' },
  { id: 'sneha', name: 'Sneha Iyer', subject: 'Chemistry', rating: 4.7, avatar: '/images/tutors/tutor-3.jpg' },
];
  ...
  return (
    <StudentDashboardLayout>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {tutors.map((tutor) => (
          <div key={tutor.id} className="overflow-hidden rounded-xl border bg-white">
            <div className="relative h-40 w-full">
              <Image src={tutor.avatar} alt={tutor.name} fill style={{ objectFit: 'cover' }} />
            </div>
            <div className="p-4">
